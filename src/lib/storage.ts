...
export async function uploadFile(
    ...
    try {
        ...
        console.log('🚀 Anonymous upload starting:', { fileName, filePath, bucket })
...
export function extractFilePathFromUrl(url: string, bucket: string = 'project-thumbnails'): string | null {
    try {
