...
const mockProjects: Project[] = [
    {
        ...
        description:
            'A fully functional e-commerce platform with a modern design.',
        thumbnail:
    ...
    },
    {
        ...
        description:
            'A user-friendly mobile app for a fitness tracking service.',
        thumbnail:
                    ...
                    <div className="flex flex-wrap justify-between gap-3 p-4">
                        <div className="flex min-w-72 flex-col gap-3">
                            ...
                            <p className="text-[#cb90b7] text-sm font-normal leading-normal">
                                Explore a curated collection of my work,
                                showcasing my skills and creativity across
                                various projects.
                            </p>
                        </div>
                    </div>
